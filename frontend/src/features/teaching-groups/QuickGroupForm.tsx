  ...
  return (
    <form className="space-y-6" onSubmit={handleSubmit}>
      ...
      <div className="grid gap-x-6 gap-y-5 md:grid-cols-3">
        <SelectInput
          ...
          onChange={(event) =>
            setValues((current) => ({
              ...current,
              createTheoryGroup: event.target.value,
            }))
          }
        />
        ...
        <TextInput
          ...
          onChange={(event) =>
            setValues((current) => ({
              ...current,
              practiceGroupCount: event.target.value,
            }))
          }
        />
        ...
        <TextInput
          ...
          onChange={(event) =>
            setValues((current) => ({
              ...current,
              maxPracticeGroupSize: event.target.value,
            }))
          }
        />
      </div>
      ...
      <div className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
        Nếu dòng lớp - học phần đã có nhóm cùng mã như LT hoặc TH1, backend sẽ
        chặn để tránh tạo trùng.
      </div>
      ...
      <div className="flex flex-col-reverse gap-3 pt-3 sm:flex-row sm:justify-end">
        ...
        <Button
          ...
          leftIcon={<Wand2 size={18} aria-hidden="true" />}
        >
          Tạo nhóm nhanh
        </Button>
      </div>
