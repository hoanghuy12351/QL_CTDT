...
import {
  groupTypeClassNames,
  teachingGroupColumns,
} from "./teachingGroup.columns";
...
export default function TeachingGroupTable({
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-slate-200 bg-white">
      {isLoading ? (
        <TableSkeleton columns={teachingGroupColumns.length} rows={5} />
      ) : null}
                ...
                <td className="px-3 py-3">
                  <span
                    className={[
                      ...
                      groupTypeClassNames[group.type],
                    ].join(" ")}
                  >
                    {group.typeLabel}
                  </span>
            ...
            {rows.length === 0 && !isLoading ? (
              <tr>
                <td
                  ...
                  colSpan={teachingGroupColumns.length}
                >
