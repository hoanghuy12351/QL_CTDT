...
INSERT IGNORE INTO `bo_mon` VALUES (2,1,'KHMT','Khoa học máy tính','2026-04-28 15:54:27'),(3,1,'HTTT','Hệ thống thông tin','2026-04-28 15:54:44'),(4,1,'CNTT','Công nghệ thông tin','2026-04-28 15:55:15'),(5,1,'CNPM','Công nghệ phần mềm','2026-04-28 15:55:35');
...
INSERT IGNORE INTO `co_so` VALUES (1,'CS1','Cơ sở Mỹ Hào','phường Mỹ Hào, tỉnh Hưng Yên'),(2,'CS2','Trụ sở chính','xã Việt Tiến, tỉnh Hưng Yên'),(3,'CS3','Cơ sở Hải Dương','Phường Lê Thanh Nghị, Thành phố Hải Phòng');
...
INSERT IGNORE INTO `hoc_ky` VALUES (1,'HK1','học kỳ 1','dang_ap_dung',1),(2,'HK2','Học kỳ 2','dang_ap_dung',1);
...
INSERT IGNORE INTO `ke_hoach_dao_tao` VALUES (1,1,1,'KH01','Kế hoạch giáo viên học kỳ 1 năm học 2025-2026','da_duyet',NULL,NULL,NULL,'2026-05-06 05:07:44','2026-05-06 12:07:48'),(5,1,1,'123','Kế hoạch giáo viên học kỳ 1 năm học 2025-2026ss222','du_thao',NULL,NULL,NULL,'2026-05-25 06:19:24','2026-05-25 06:19:24'),(6,1,1,'KH012s','Kế hoạch giáo viên học kỳ 1 năm học 2025-2026','du_thao',NULL,NULL,NULL,'2026-05-25 07:04:23','2026-05-25 07:04:23');
...
INSERT IGNORE INTO `ke_hoach_lop_hoc_phan` VALUES (1,1,1,1,1,25,1,1,1,'goi_y_tu_ctdt',NULL,'da_len_ke_hoach',NULL,'2026-05-06 05:11:21'),(2,4,2,1,6,40,1,1,2,'goi_y_tu_ctdt',NULL,'da_len_ke_hoach',NULL,'2026-05-25 11:38:34'),(3,4,1,2,4,25,1,1,1,'goi_y_tu_ctdt',NULL,'da_len_ke_hoach',NULL,'2026-05-25 11:38:34');
...
INSERT IGNORE INTO `khoa` VALUES (1,'CNTT','Khoa Cong nghe Thong tin','2026-04-27 19:00:21');
...
INSERT IGNORE INTO `khoa_hoc` VALUES (1,'K21','2023-2027',2023,2027),(2,'K20','2022-2026',2022,2026),(3,'K22','2024-2028',2024,2028),(4,'K23','2025-2029',2025,2029);
...
INSERT IGNORE INTO `lich_day_theo_tuan` VALUES (1,1,1,NULL,15.0,NULL,NULL,'2026-05-06 05:13:04'),(2,1,3,NULL,15.0,NULL,NULL,'2026-05-06 05:13:04');
...
INSERT IGNORE INTO `nam_hoc` VALUES (1,'2025-2026','2026-04-29','2026-05-20','du_thao','2026-04-28 14:17:16');
...
INSERT IGNORE INTO `nganh` VALUES (2,1,'7480101','Khoa học máy tính','2026-04-28 16:41:52',NULL),(3,1,'7480103','Kỹ thuật phần mềm','2026-04-28 17:11:01',NULL),(4,1,'7480107','Trí tuệ nhân tạo','2026-04-28 17:11:15',NULL),(5,1,'7480201','Công nghệ thông tin','2026-04-28 17:11:54',NULL);
...
INSERT IGNORE INTO `phong_hoc` VALUES (1,3,'123','123',44,'thuc_hanh');
...
INSERT IGNORE INTO `tien_do_hoc_phan_lop` VALUES (1,1,1,1,'dang_hoc',NULL,NULL,NULL,NULL),(2,1,4,7,'chua_hoc',NULL,NULL,NULL,NULL),(15,2,6,5,'chua_hoc',NULL,NULL,NULL,NULL),(16,2,5,6,'chua_hoc',NULL,NULL,NULL,NULL);
...
INSERT IGNORE INTO `tuan_dao_tao` VALUES (1,1,1,'Tuan 1','2026-04-28','2026-05-02','hoc',NULL),(2,1,2,'Tuan 2','2026-05-03','2026-05-09','hoc',NULL),(3,1,3,'Tuan 3','2026-05-10','2026-05-16','hoc',NULL),(4,1,4,'Tuan 4','2026-05-17','2026-05-19','hoc',NULL);
